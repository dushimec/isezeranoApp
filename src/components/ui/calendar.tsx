    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-8 w-8 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 text-[0.75rem] sm:text-[0.9rem]"
        ),
      ...
      formatters={{
        formatWeekdayName: (date: Date) => new Intl.DateTimeFormat(undefined, { weekday: 'short' }).format(date)
      }}
      {...props}
    />
  )
